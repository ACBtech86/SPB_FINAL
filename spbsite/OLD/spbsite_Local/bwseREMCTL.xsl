...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
  ...
  <xsl:template match="MainTag">
    ...
    <TABLE STYLE="font:8pt Verdana; background-color:white">
      ...
      <TCabecalho>      
        <TD width="120"><DIV class="fntCabecTab" onClick="Classifica('CNPJ')">CNPJ</DIV></TD>
        <TD width="300"><DIV class="fntCabecTab" onClick="Classifica('NOME_CNPJ')">NOME_CNPJ</DIV></TD>
		...
		<TD width="200"><DIV class="fntCabecTab" onClick="Classifica('ULTMSG')">ULTMSG</DIV></TD>
        <TD width="200"><DIV class="fntCabecTab" onClick="Classifica('DTHR_ULTMSG')">DTHR_ULTMSG</DIV></TD>
